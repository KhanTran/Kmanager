...
//            }];
    ...
    if (_isEdit == 1) {
        ...
        [[Server sharedServer] putData:[NSString stringWithFormat:@"%@customer", ServerApi] param:postDic completion:^(NSError *error, NSDictionary *data){
    ...
    else
    {
        ...
        [[Server sharedServer] postData:[NSString stringWithFormat:@"%@customer", ServerApi] param:postDic completion:^(NSError *error, NSDictionary *data){
            [[Server sharedServer] hideAnimation:self.view];
