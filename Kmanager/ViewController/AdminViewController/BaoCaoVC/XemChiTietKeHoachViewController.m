//
//  XemChiTietKeHoachViewController.m
//  Kmanager
//
...
@interface XemChiTietKeHoachViewController ()
{
...
@implementation XemChiTietKeHoachViewController
...

{
    ...
    SanPhamObj *dicSP = [arrSPSend objectAtIndex:indexPath.row];
    idSp = dicSP.idSanPham;
    [self performSegueWithIdentifier:@"BaoCaoLoaiSPIdentifier" sender:nil];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([[segue identifier] isEqualToString:@"BaoCaoLoaiSPIdentifier"]) {
